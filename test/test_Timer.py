...
class TestTimer(unittest.TestCase):
    ...
    def test___init__(self):
        ...
        self.assertEqual(fps, timer.get_fps())
        self.assertEqual(fps_max, timer.get_fps_max())
        self.assertEqual(fps_min, timer.get_fps_min())
        self.assertEqual(fps_increment, timer.get_fps_increment())
        self.assertEqual(fps_min_increment, timer.get_fps_min_increment())
        self.assertEqual(fps_max_increment, timer.get_fps_max_increment())

    # Test "fps" attribute
    def test_get_set_fps(self):
        """Timer: Test fps attribute with set_fps() and get_fps() method's"""
    ...
    def test_raise_typeerror_set_fps(self):
        """Timer: Test raise TypeError when set fps with worng type"""
        random_value = randint(1, 250)
        self.assertRaises(TypeError, self.timer.set_fps, int(random_value))

    # Test "min_fps" attribute
    def test_get_set_min_fps(self):
        """Timer: Test min_fps attribute with set_min_fps() and get_min_fps() method's"""
        random_value = randint(1, 250)
    ...
    def test_get_set_fps_increment(self):
        """Timer: Test fps_increment attribute with set_fps_increment() and get_fps_increment() method's"""
        random_value = randint(1, 250)
    ...
    def test_raise_typeerror_set_fps_increment(self):
        """Timer: Test raise TypeError when set fps_increment with worng type"""
        random_value = randint(1, 250)
    ...
    def test_get_set_min_fps_increment(self):
        """Timer: Test min_fps_increment attribute with set_min_fps_increment() and get_min_fps_increment() method's"""
        random_value = randint(1, 250)
    ...
    def test_raise_typeerror_set_min_fps_increment(self):
        """Timer: Test raise TypeError when set min_fps_increment with worng type"""
        random_value = randint(1, 250)
    ...
    def test_get_set_max_fps_increment(self):
        """Timer: Test max_fps_increment attribute with set_max_fps_increment() and get_min_fps_increment() method's"""
    ...
    def test_get_set__max_frame(self):
        """Timer: Test max_frame attribute with _set_frame_max() and _get_frame_max() method's"""
        random_value = randint(1, 250)
    ...
    def test_raise_typeerror_set__max_frame(self):
        """Timer: Test if _set_frame_max() raise TypeError when use a wrong type"""
        random_value = randint(1, 250)
        self.assertRaises(TypeError, self.timer._set_frame_max, float(random_value))

    # Test "frame" attribute
    def test_get_set__frame(self):
        """Timer: Test frame attribute with _set_frame() and _get_frame() method's"""
        random_value = randint(1, 250)
    ...
    def test_raise_typeerror_set__frame(self):
        """Timer: Test if _set_frame() raise TypeError when use a wrong type"""
        random_value = randint(1, 250)
    ...
    def test_get_set__departure_time(self):
        """Timer: Test __departure_time attribute with _set_time_departure() and _get_time_departure() method's"""
        tested_value = time()
    ...
    def test_get_set__fps_memory(self):
        """Timer: Test fps_memory attribute with _set_fps_memory() and _get_fps_memory() method's"""
    ...
    def test_raise_typeerror__set_fps_memory(self):
        """Timer: Test if _set_fps_memory() raise TypeError when use a wrong type"""
        random_value = randint(1, 250)
    ...
    def test_if_set_fps_memory_return_empty_list_when_param_is_none(self):
        """Timer: Test if _get_fps_memory() return a empty list() when _set_fps_memory(None)"""
        # our empty list
        value_list = list()
    ...
    def test_if_fps_memory_list_have_a_adaptive_size(self):
        """Timer: Test if by play with set _set_frame_max the get_fps_memory() return list have the good size"""
    ...
    def test_get_set__be_bast(self):
        """Timer: Test if __be_bast have the get and set methods it work"""
        value_tested = True
    ...
    def test_raise_set__be_bast(self):
        """Timer: Test raise TypeError when _set_be_fast() use a wrong type"""
    ...
    def test_get_set_be_fast_multiplicator(self):
        """Timer: Test if __be_fast_multiplicator have the get and set methods it work"""
    ...
    def test_raise_set_be_fast_multiplicator(self):
        """Timer: Test raise TypeError when _set_be_fast_multiplicator() use a wrong type"""
